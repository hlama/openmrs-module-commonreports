...
@Component
public class DRCHIVCervicalCancer extends ActivatedReportManager {
	...
	public String getUuid() {
		return "7accc813-75ec-482c-9e95-de8fe53150da";
	}
	
	@Override
	public String getName() {
		return MessageUtil.translate("commonreports.report.drc.cervicalcancer.reportName");
	}
	
	@Override
	public String getDescription() {
		return MessageUtil.translate("commonreports.report.drc.cervicalcancer.reportDescription");
	}
	...
	public String getCervicalCancerName() {
		return MessageUtil.translate("commonreports.report.drc.cervicalcancer.reportName");
	}
	...
	public ReportDefinition constructReportDefinition() {
		...
		CohortCrossTabDataSetDefinition cervicalCancer = new CohortCrossTabDataSetDefinition();
		cervicalCancer.addParameters(getParameters());
		rd.addDataSetDefinition(getCervicalCancerName(), Mapped.mapStraightThrough(cervicalCancer));
		...
		List<Concept> cervicalCancerList = new ArrayList<>();
		cervicalCancerList.add(cs.getConceptByUuid("165619AAAAAAAAAAAAAAAAAAAAAAAAAAAAAA"));
		
		CodedObsCohortDefinition cervicalCancerPerfomed = new CodedObsCohortDefinition();
		cervicalCancerPerfomed.addParameter(new Parameter("onOrAfter", "On Or After", Date.class));
		cervicalCancerPerfomed.addParameter(new Parameter("onOrBefore", "On Or Before", Date.class));
		cervicalCancerPerfomed.setOperator(SetComparator.IN);
		cervicalCancerPerfomed.setQuestion(cs.getConceptByUuid("e5e99fc7-ff2d-4306-aefd-b87a07fc9ab4"));
		cervicalCancerPerfomed.setValueList(cervicalCancerList);
		cervicalCancerPerfomed.setTimeModifier(TimeModifier.LAST);
		...
		hivStage3And4Obs.setQuestion(cs.getConceptByUuid("165619AAAAAAAAAAAAAAAAAAAAAAAAAAAAAA"));
		...
		referallOption.add(cs.getConceptByUuid("e5e99fc7-ff2d-4306-aefd-b87a07fc9ab4")); //Yes
		...
		referredObs.setQuestion(cs.getConceptByUuid("165619AAAAAAAAAAAAAAAAAAAAAAAAAAAAAA")); //Referred
		...
		cervicalCancer.addColumn(col1, createCohortComposition(males), null);
		 */
		GenderCohortDefinition females = new GenderCohortDefinition();
		females.setFemaleIncluded(true);
		//cervicalCancer.addColumn(col2, createCohortComposition(females), null);
		...
		cervicalCancer.addColumn(col3, createCohortComposition(allGenders), null);
		 */
		
		CompositionCohortDefinition ccd = new CompositionCohortDefinition();
		ccd.initializeFromElements(livePatients, females, visits, cervicalCancerPerfomed);
		cervicalCancer.addRow(MessageUtil.translate("commonreports.report.drc.cervicalcancer.reportName"), ccd,
		    parameterMappings);
		...
		/* 
			...
			cervicalCancer.addColumn(col4, createCohortComposition(under1y), null);
	...
	public List<ReportDesign> constructReportDesigns(ReportDefinition reportDefinition) {
		return Arrays
		        .asList(ReportManagerUtil.createCsvReportDesign("7accc813-75ec-482c-9e95-de8fe53150dx", reportDefinition));
	}
}
